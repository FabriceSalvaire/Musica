...
class STD_ANON (pyxb.binding.datatypes.NMTOKEN, pyxb.binding.basis.enumeration_mixin):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/fabrice/Musica/specifications/MusicXML-3.0/xlink.xsd', 23, 2)
    _Documentation = None
...
class STD_ANON_ (pyxb.binding.datatypes.NMTOKEN, pyxb.binding.basis.enumeration_mixin):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/fabrice/Musica/specifications/MusicXML-3.0/xlink.xsd', 35, 2)
    _Documentation = None
...
class STD_ANON_2 (pyxb.binding.datatypes.NMTOKEN, pyxb.binding.basis.enumeration_mixin):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/fabrice/Musica/specifications/MusicXML-3.0/xlink.xsd', 47, 2)
    _Documentation = None
